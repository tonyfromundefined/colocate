...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "dependencyTreeRoots": [\
      {\
        "name": "@colocate/monorepo",\
        "reference": "workspace:."\
      },\
      {\
        "name": "@colocate/transform",\
        "reference": "workspace:transform"\
      }\
    ],\
    "enableTopLevelFallback": true,\
    "ignorePatternData": "(^(?:\\\\.yarn\\\\/sdks(?:\\\\/(?!\\\\.{1,2}(?:\\\\/|$))(?:(?:(?!(?:^|\\\\/)\\\\.{1,2}(?:\\\\/|$)).)*?)|$))$)",\
    "fallbackExclusionList": [\
      ["@colocate/monorepo", ["workspace:."]],\
      ["@colocate/transform", ["workspace:transform"]]\
    ],\
    "fallbackPool": [\
    ],\
    "packageRegistryData": [\
      ...
      ["zora", [\
        ["npm:5.0.3", {\
          "packageLocation": "./.yarn/cache/zora-npm-5.0.3-f62df984f9-c57f99460d.zip/node_modules/zora/",\
          "packageDependencies": [\
            ["zora", "npm:5.0.3"]\
          ],\
          "linkType": "HARD"\
